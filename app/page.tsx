          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                ...
                Tuna Group, 2000 yılından bu yana sağlık teknolojileri ve endüstriyel üretim alanlarında faaliyet gösteren çok sektörlü bir şirkettir. Ambalaj ve çuval üretimini bünyesine katarak endüstriyel çözümler alanında da güçlü bir yapıya kavuşmuştur.
              </motion.p>
            ...
            >
              ...
              <div className="relative h-[400px] sm:h-[500px] lg:h-[600px]">
                ...
                {/* Side Info Card */}
                <motion.div
                  className="absolute -bottom-6 -left-6 z-10 bg-white/95 backdrop-blur-sm p-6 rounded-2xl shadow-2xl border border-white/20 max-w-xs"
