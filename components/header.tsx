            ...
            <nav className="hidden lg:flex items-center space-x-1">
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <span className="text-sm font-medium">Tuna Group</span>
                  <ChevronDown
                    className={`w-3 h-3 transition-transform duration-300 ${isGroupDropdownOpen ? "rotate-180" : ""}`}
                  />
                </motion.button>
                ...
                <AnimatePresence>
                  {isGroupDropdownOpen && (
                    <motion.div
                      ...
                      className="absolute top-full right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden z-50"
                    >
              ...
              <div className="h-full flex flex-col">
                ...
                <nav className="flex-1 overflow-y-auto p-4">
                  <div className="space-y-2">
                    ...
                    <div className="pt-2">
                      <motion.button
                        onClick={() => setIsMobileGroupOpen(!isMobileGroupOpen)}
                        className="w-full flex items-center justify-between p-4 rounded-lg transition-all duration-300 text-gray-700 hover:bg-gradient-to-r hover:from-red-50 hover:to-navy-50 hover:text-navy-900"
                        whileHover={{ scale: 1.02 }}
                      >
                        <span className="font-medium">Tuna Group</span>
                        <ChevronDown
                          className={`w-4 h-4 transition-transform duration-300 ${isMobileGroupOpen ? "rotate-180" : ""}`}
                        />
                      </motion.button>
                      ...
                      <AnimatePresence>
                        {isMobileGroupOpen && (
                          <motion.div
                            ...
                            transition={{ duration: 0.2 }}
                            className="ml-2 mt-1 overflow-hidden rounded-lg border border-gray-100 bg-white"
                          >
                            {groupLinks.map((link) => (
                              <a
                                key={link.href}
